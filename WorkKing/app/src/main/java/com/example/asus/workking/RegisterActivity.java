        ...
        this.mEnter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (isEmpty()){
                    ...
                    RegsterThread regsterThread = new RegsterThread(mUsername.getText().toString(),mPassword.getText().toString(),"0");
                    regsterThread.start();
                    System.out.println("register + " + regsterThread.getFlag());
